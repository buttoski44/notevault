        ...
        >
            ...
            >
                <h1
                    ...
                    spellCheck="false"
                    className="outline-0 text-2xl md:text-6xl py-4 empty:opacity-[0.2] empty:before:content-[attr(before)]" id="title"
                ...
                <div className="h-[1px] w-full bg-black rounded-full opacity-[0.5] my-2"></div>
                <p
                    before="Write Here..."
                    contentEditable="true"
                    spellCheck="false"
